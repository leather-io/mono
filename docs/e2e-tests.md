...
Whenever you create a new flow, don't forget to add it in expo build CI [here](../apps/mobile/.eas/build/build-and-maestro-test.yml)
...
1. [API REFERENCE](https://maestro.mobile.dev/api-reference/commands)
