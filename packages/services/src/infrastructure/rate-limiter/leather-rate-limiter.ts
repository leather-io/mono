...
const leatherApiLimiterSettings: RateLimiterQueueOptions = {
  interval: 1000,
  intervalCap: 20,
  timeout: 60000,
};
...
export const leatherApiPriorities = {
  ...
  stakingBonds: leatherPriorityLevels.MEDIUM,
  ...
  sbtcSponsorshipQuote: leatherPriorityLevels.HIGH,
  sbtcSponsorshipSubmit: leatherPriorityLevels.HIGH,
};
