...
export * from './activity/function-icon.web';
...
export * from './coins-stack-icon.web';
...
export * from './rocket-startup-launch-icon.web';
export * from './question-circle-icon.web';
export * from './search-icon.web';
