...
export { Avatar, getAvatarFallback, defaultFallbackDelay } from './avatar.web';
...
export { Stx20AvatarIcon } from './stx20-avatar-icon.web';
export { StampsAvatarIcon } from './stamps-avatar-icon.web';
