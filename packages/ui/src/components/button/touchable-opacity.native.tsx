...
export const TouchableOpacity: ReturnType<
  typeof createRestyleComponent<TouchableOpacityProps<Theme>, Theme>
> = createRestyleComponent<TouchableOpacityProps<Theme>, Theme>(
