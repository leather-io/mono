...
import { HelpCenterCategoriesQueryResult, helpCenterCategoriesQuery } from '@leather.io/cms';
...
type LoaderResult = Promise<{
  categories: HelpCenterCategoriesQueryResult;
}>;
export async function loader(): LoaderResult {
  const categories = await cmsClient.fetch(helpCenterCategoriesQuery);
