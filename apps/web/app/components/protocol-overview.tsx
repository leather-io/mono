...
function RewardTokenCell({ icon, symbol }: RewardTokenCellProps): ReactElement {
  ...
  return (
    <ValueDisplayer
      name={<LearnHoverCard article={article} label="Rewards token" textStyle="label.02" />}
      value={
...
function LockupPeriodCell({ lockupPeriod = '1 Cycle' }: LockupPeriodCellProps): ReactElement {
  ...
  return (
    <ValueDisplayer
      name={<LearnHoverCard article={article} label="Minimum lockup period" textStyle="label.02" />}
      value={lockupPeriod}
    />
  );
}
...
function DaysUntilNextCycleCell({
  ...
  return (
    <ValueDisplayer
      name={<LearnHoverCard article={article} label="Days until next cycle" textStyle="label.02" />}
      value={
        <>
...
function MinimumCommitmentCell({
  ...
  return (
    <ValueDisplayer
      name={<LearnHoverCard article={article} label="Minimum commitment" textStyle="label.02" />}
      value={
        <>
...
function HistoricalAprCell({ apr }: HistoricalAprCellProps): ReactElement {
  ...
  return (
    <ValueDisplayer
      name={<LearnHoverCard article={article} label="Historical yield" textStyle="label.02" />}
...
function TotalValueLockedCell({
  ...
  return (
    <ValueDisplayer
      name={<LearnHoverCard article={article} label="Total value locked" textStyle="label.02" />}
      value={
        <>
...
function ProtocolCell({ description, icon, name }: ProtocolCellProps): ReactElement {
  return (
