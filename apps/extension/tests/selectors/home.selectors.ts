export enum HomePageSelectors {
  ...
  ReceiveBtcNativeSegwitVerifyBtn = 'receive-native-segwit-verify-btn',
  ReceiveBtcTaprootVerifyBtn = 'receive-taproot-verify-btn',
  ReceiveStxVerifyBtn = 'receive-stx-verify-btn',
  ReceiveSheetVerifyAddressBtn = 'receive-sheet-verify-address-btn',
