...
function isBitcoinFeeQuote(quote: TransactionFeeQuote): quote is BitcoinTransactionFeeQuote {
  return quote.type === 'bitcoinFeeRate';
}
...
function mapFeeQuoteToListItem(
  ...
  if (!isBitcoinFeeQuote(quote)) return null;
  return {
    label,
