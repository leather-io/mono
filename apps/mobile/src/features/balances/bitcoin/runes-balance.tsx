...
import { BitcoinAccountIdentifier } from '@leather.io/services';
...
interface RunesBalanceByAccountProps {
  account: BitcoinAccountIdentifier;
}
export function RunesBalanceByAccount({ account }: RunesBalanceByAccountProps) {
